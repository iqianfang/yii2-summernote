...
(function (factory) {
  ...
  var dialog = renderer.create('<div class="modal" aria-hidden="false" tabindex="-1"/>', function ($node, options) {
    ...
    $node.html([
      ...
      '      <button type="button" class="close close-self-modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>' +
  ...
  */
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group note-group-select-from-files">' +
                   '<label for="snImgHandle" class="btn btn-primary">' + lang.image.selectFromFiles + '</label>' +
                   '<input id="snImgHandle" class="hidden note-image-input form-control" type="file" name="files" accept="image/*" multiple="multiple" />' +
                   imageLimitation +
                 '</div>' +
              ''+
    ...
    this.showImageDialog = function () {
      return $.Deferred(function (deferred) {
        var $imageInput = self.$dialog.find('.note-image-input'),
            ...
            $closeSelf = self.$dialog.find('.close-self-modal');
        ...
        ui.onDialogShown(self.$dialog, function () {
          ...
          //关闭当前model
          $closeSelf.click(function (event) {
            ui.hideDialog(self.$dialog)
          });
  ...
  var VideoDialog = function (context) {
    ...
    this.showVideoDialog = function (text) {
      return $.Deferred(function (deferred) {
        var $closeSelf = self.$dialog.find('.close-self-modal');
